...
fs.renameSync(path.join('target', 'release', 'native-rust'), path.join('build', 'linux', execLinux))
fs.renameSync(path.join('target', 'x86_64-pc-windows-gnu', 'release', 'native-rust.exe'), path.join('build', 'win', execWin))
